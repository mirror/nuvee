...
BOOL unregister_raw_mouse( HWND hwnd )
{
	  ...
	  // Register to STOP receive the WM_INPUT message for any change in mouse (buttons, wheel, and movement will all generate the same message)
		if (!/* RegisterRawInputDevices*/ (*_RRID)(Rid, 1, sizeof (Rid[0])))
			return 0;
